...
const Devops = () =>{
    ...
    return(
        <div className='routeComp'>
            ...
            <p className='feParagraph'>
                • Web apps and back end applications dockerized as part of deployment process. Experience working on and building Dockerfiles for react and Scala applications.
            </p>
